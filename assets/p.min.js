...
jQuery(document).ready(function () {
    ...
    //         }, 1000);
    // }
    // if (jQuery("#timerr").length >= 1) { d((2 * 60) + 10); }
...
jQuery(document).ready(function () {
    ...
    var bw = new Date();// Get today's date
    bw.setDate(bw.getDate() + 10); // Add 10 days

    // Get the new date and month after the addition
    jQuery(".js-info_dia-next2").text(bw.getDate());
    jQuery(".js-info_mes-nombre-next2").text(monthNames[bw.getMonth()]);
});
